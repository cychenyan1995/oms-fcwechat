...
public class ExampleClient {
    ...
    //public static final String SERVER_URL = "http://devwx.glsx.com.cn/fcwechat/router";
    //public static final String SERVER_URL = "http://qcwx.glsx.net/fcwechat/router";
    public static final String SERVER_URL = "http://qcwx.glsx.com.cn/fcwechat/router";
    //public static final String SERVER_URL = "http://192.168.1.36:8460/fcwechat/router";
    ...
    public void testQrCodeGenerate() {
        RestTemplate restTemplate = new RestTemplate();
        MultiValueMap<String, String> form = new LinkedMultiValueMap<String, String>();
        form.add("method", "glsx.fcwechat.api.qrCodeGenerate");//<--指定方法名称
        form.add("appKey", "48e5e13229b82c1b4e6e8c96151f0637");
        form.add("v", "1.0.0");
        form.add("sessionId", "mockSessionId1");
        form.add("messageFormat", "json");
        form.add("kewWord", "467067001067327");
        String response = restTemplate.postForObject(SERVER_URL, form, String.class);
        System.out.println("response:\n" + response);
    }
}
