...
import com.glsx.oms.fcwechat.framework.handler.FcWechatHandler;
import com.glsx.oms.fcwechat.framework.interceptor.FcWechatInterceptor;
import com.glsx.oms.fcwechat.framework.matcher.FcWechatMatcher;
...
//				String signature = request.getParameter("signature");
				...
				router.rule().matcher(new FcWechatMatcher()).interceptor(new FcWechatInterceptor()).handler(new FcWechatHandler()).end();
